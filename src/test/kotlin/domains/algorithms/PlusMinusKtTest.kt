...
class PlusMinusKtTest {
    ...
    @Test
    fun plusMinus() {
        val (positive1, negative1, zero1) = domains.algorithms.plusMinus(arrayOf(1,1,0,-1,-1))
        assertEquals(0.4f, positive1)
        assertEquals(0.4f, negative1)
        assertEquals(0.2f, zero1)

        val (positive2, negative2, zero2) = domains.algorithms.plusMinus(arrayOf(-4, 3, -9, 0, 4, 1))
